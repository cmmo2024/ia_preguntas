"""
Django settings for ia_preguntas project.
...
SECRET_KEY = 'django-insecure-^rd^0=sfw245bn)655n54g4ml8!m+^*(01m%tjrfqc430h0h3='
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'Cl@u29144'),
...
SOCIALACCOUNT_LOGIN_ERROR_URL = '/login/'
...
CELERY_TIMEZONE = 'America/Havana'  # Cambia a tu zona horaria
